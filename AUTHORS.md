...
gd is maintained by mofukuma. Every contributor remains the author of their
commits; the Git history is the authoritative record.

gd derives from Godot Engine. The upstream contributors retained below wrote
the engine code on which gd is based.
