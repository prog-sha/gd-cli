...
- Upstream: https://go.googlesource.com/go/+/refs/tags/go1.26.5/src/html/template/
- Version: go1.26.5
- License: BSD-3-Clause

The contextual state machine and escaping rules are adapted into
`cli/api/html_context.cpp` and `cli/api/html_context.h`.
...
The amalgamation source, archive checksum, and source checksum are recorded in
