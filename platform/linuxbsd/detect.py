...
def get_opts():
    ...
    return [
        ...
        BoolVariable("alsa", "Use ALSA", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("pulseaudio", "Use PulseAudio", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("dbus", "Use D-Bus to handle screensaver and portal desktop settings", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("speechd", "Use Speech Dispatcher for Text-to-Speech support", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("fontconfig", "Use fontconfig for system fonts support", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("udev", "Use udev for gamepad connection callbacks", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("x11", "Enable X11 display", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("wayland", "Enable Wayland display", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("libdecor", "Enable libdecor support", False),  # Keep display, audio, and input in the optional game layer.
        BoolVariable("touch", "Enable touch events", False),  # Keep display, audio, and input in the optional game layer.
